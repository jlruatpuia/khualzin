...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
    ...
    {{-- </h6> --}}
    <div class="container">
        <form method="post" action="{{ route('routes.store') }}" class="form-floating">
            @csrf
            ...
            <div class="form-floating mb-3">
                <input type="number" class="form-control @error('fare') is-invalid @enderror" id="fare" name="fare" placeholder="Fare amount" required>
